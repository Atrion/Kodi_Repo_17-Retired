...
class OrionIntegration:
	...
	Addons = [AddonGaia, AddonIncursion, AddonPlacenta, AddonCovenant, AddonMagicality, AddonYoda, AddonBodie, AddonNeptuneRising, AddonDeathStreams, AddonExodusRedux, AddonLambdaScrapers, AddonUniversalScrapers, AddonNanScrapers]
	...
	def executeExodusRedux(self):
		if OrionInterface.dialogOption(title = 32174, message = OrionTools.translate(33023) % (self.AddonExodusRedux, self.AddonLambdaScrapers, self.AddonLambdaScrapers)):
			return self.executeLambdaScrapers()
		else:
			return False
